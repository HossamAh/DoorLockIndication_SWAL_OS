 ...
 */
DeclareApplicationMode(AppStd);
DeclareTask(DoorLockIndicationTask);
DeclareTask(LEDSwitchTask);
DeclareTask(ReadDoorT);
DeclareAlarm(Time10ms_Alarm);
DeclareEvent(DoorStateReceivedEvent);
DeclareEvent(LedSwitchInvokeEvent);
DeclareEvent(Time_10ms_Event);
